...
export DATA_ROOT="/mnt/c/Users/dndlssardar/Downloads/THZ_dataset_det_VOC/JPEGImages"
# run training
python train.py \
  --phase train \
  \
  --name abstudy_8_128x128_20230111 \
  --model skipattentionganomaly \
  \
  --dataroot "$DATA_ROOT" \
  --atz_patch_db customdataset/atz/atz_patch_dataset__3_128_36.csv\
  --atz_train_txt customdataset/atz/set_ablation_5/atz_dataset_train_ablation_5.txt\
  --atz_test_txt customdataset/atz/set_ablation_5/atz_dataset_test_ablation_5.txt\
  --manualseed 47 \
  --dataset atz \
  \
  --verbose \
